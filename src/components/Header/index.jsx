    ...
    >
      <div className="navbar-start flex items-center gap-2 sm:gap-5 ">
        <div className="dropdown">
          ...
          <ul
            tabIndex={0}
            className={`menu menu-sm md:menu-md dropdown-content bg-gray-950 rounded-box mt-3 w-52 p-2 shadow z-50 ${
              isSun && "bg-gray-100 text-blue-900"
            }`}
          >
            {renderGenres()}
          </ul>
        ...
        <label className="swap swap-rotate">
          ...
          <svg
            className="swap-off  h-6 w-5 fill-current"
