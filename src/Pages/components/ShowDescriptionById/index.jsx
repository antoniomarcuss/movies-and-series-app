...
// import { ApiImg } from "../../../consts/index";

// const ShowDescriptionById = ({ category, title }) => {
//   return (
//     <div className="md:max-w-[1600px] md:w-[90%]  m-auto">
//       <h1 className=" pl-4 text-lg md:text-xl text-white font-medium">
//         {title}
//       </h1>
//       <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 mx-1 mt-4 space-x-1 lg:space-4 gap-y-4  ">
//         {category.map((item) => (
//           <Link to="/" key={item.id}>
...
// export default ShowDescriptionById;

// ShowDescriptionById.propTypes = {
